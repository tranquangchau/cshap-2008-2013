...
namespace NhatKy
{
    public partial class frmQuanHe : Form
    {
        ...
        {
            StreamReader sr = new StreamReader("data/hdquanhe.txt");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                StreamWriter sw = new StreamWriter("data/ghichepquanhe.txt", true, Encoding.UTF8);
